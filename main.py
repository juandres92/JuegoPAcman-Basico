...
class Game:
	...
	def instanciarTextosPresentacion(self):
		...
		textoTitulo = Textos(self, 'PACJUAN', 180, centerx, centery - 200, self.AMARILLO)
		textoPulseEnter = Textos(self, ' Pulse ENTER para divertirse... ', 
	...
	def instanciaTextosGameOver(self, centerx, centery):
		...
		textoGameOver = Textos(self, ' OPA VY´A ', self.RESOLUCION[0] // 8, centerx, 
